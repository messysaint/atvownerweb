...
/*     */ 
/*     */ public class saveNewNotificationRecord
/*     */ {
...
/*     */ 
/*     */   public saveNewNotificationRecord()
/*     */   {
/*     */     try
/*     */     {
...
/*     */   }
/*     */ 
/*     */   public boolean WriteToDB(String vin, String paramname, String baselinevalue, String upperlimitvalue, String lowerlimitvalue, String upperlimitmessage, String lowerlimitmessage, String sendtype)
/*     */   {
...
/*     */       try
/*     */       {
/*  82 */         if (sendtype.toUpperCase().startsWith("I"))
/*  83 */           sendtype = "i";
/*     */         else {
/*  85 */           sendtype = "g";
/*     */         }
/*  87 */         SQLStr = "INSERT INTO abrstech_obd2db.car_obd2_notifications ( datetime, vin, paramname, baselinevalue, upperlimitvalue, lowerlimitvalue, upperlimitmessage, lowerlimitmessage, sendtype ) VALUES ( \"" + 
/*  88 */           SystemDT + "\", \"" + vin + "\",\"" + paramname + "\",\"" + baselinevalue + "\",\"" + upperlimitvalue + "\",\"" + lowerlimitvalue + "\",\"" + upperlimitmessage + "\",\"" + lowerlimitmessage + "\",\"" + sendtype + "\" )";
/*     */ 
 ...
 * Qualified Name:     com.abrstech.sql.saveNewNotificationRecord
