...
/*     */ 
/*     */ public class saveNewBusinessRecord
/*     */ {
...
/*     */   }
/*     */ 
/*     */   public boolean WriteToDB(String referreremail, String country, String businessname, String citytown, String state, String zipcode, String email, String businessdescription, String website, String phone, String reminderquestion, String reminderanswer, String servicedzipcodes)
/*     */   {
...
/*     */       try
/*     */       {
/*  87 */         SQLStr = "INSERT INTO abrstech_obd2db.auto_business_tbl ( datetime, referreremail, country, businessname, citytown, state, zipcode, email, businessdescription, website, phone, reminderquestion, reminderanswer, servicedzipcodes ) VALUES ( \"" + 
/*  88 */           SystemDT + "\", \"" + referreremail + "\",\"" + country + "\",\"" + businessname + "\",\"" + citytown + "\",\"" + state + "\",\"" + zipcode + "\",\"" + email + "\",\"" + businessdescription + "\",\"" + website + "\",\"" + phone + "\",\"" + reminderquestion + "\",\"" + reminderanswer + "\",\"" + servicedzipcodes + "\" )";
/*     */ 
 ...
 * Qualified Name:     com.abrstech.sql.saveNewBusinessRecord
