...
/*     */ 
/*     */ public class saveNotificationEmails
/*     */ {
...
/*     */   }
/*     */ 
/*     */   public boolean WriteToDB(String VIN, String nickname, String notifyemail)
/*     */   {
...
/*     */       try
/*     */       {
/*  82 */         SQLStr = "UPDATE abrstech_obd2db.ref_car_tbl SET nickname = \"" + 
/*  83 */           nickname + "\", " + "notifyemail = \"" + notifyemail.trim() + "\" " + 
/*  84 */           "WHERE vin = \"" + VIN + "\"";
/*     */ 
/*  89 */         this.stmt.executeUpdate(SQLStr);
/*  90 */         System.out.println("Ok: " + SQLStr);
/*  91 */         rvalue = true;
/*     */       }
/*     */       catch (SQLException ex)
/*     */       {
/*  98 */         System.out.println("Ok: " + SQLStr);
 ...
 * Qualified Name:     com.abrstech.sql.saveNotificationEmails
