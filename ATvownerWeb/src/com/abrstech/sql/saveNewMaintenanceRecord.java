...
/*     */ 
/*     */ public class saveNewMaintenanceRecord
/*     */ {
...
/*     */ 
/*     */   public saveNewMaintenanceRecord()
/*     */   {
/*     */     try
/*     */     {
...
/*     */   }
/*     */ 
/*     */   public boolean WriteToDB(String ref_car_tbl_seqno, String vin, String dateOfService, String cost, String odometer, String servicesPerformed)
/*     */   {
...
/*     */       try
/*     */       {
/*  87 */         SQLStr = "INSERT INTO abrstech_obd2db.car_mtnc_tbl ( datetime, ref_car_tbl_seqno, vin, dateofservice, cost, odometer, servicesperformed ) VALUES ( \"" + 
/*  88 */           SystemDT + "\", \"" + ref_car_tbl_seqno + "\",\"" + vin + "\",\"" + dateOfService + "\",\"" + cost + "\",\"" + odometer + "\",\"" + servicesPerformed + "\" )";
/*     */ 
 ...
 * Qualified Name:     com.abrstech.sql.saveNewMaintenanceRecord
