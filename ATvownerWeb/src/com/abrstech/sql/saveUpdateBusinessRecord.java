...
/*     */ 
/*     */ public class saveUpdateBusinessRecord
/*     */ {
...
/*     */ 
/*     */   public saveUpdateBusinessRecord()
/*     */   {
/*     */     try
/*     */     {
...
/*     */   }
/*     */ 
/*     */   public boolean WriteToDB(Integer seqno, String businessname, String citytown, String state, String zipcode, String email, String businessdescription, String website, String phone, String servicedzipcodes)
/*     */   {
...
/*     */       try
/*     */       {
/*  87 */         SQLStr = "UPDATE abrstech_obd2db.auto_business_tbl SET businessname = \"" + businessname + "\", citytown = \"" + citytown + "\", state = \"" + state + "\", zipcode = \"" + zipcode + "\", email = \"" + email + "\", businessdescription = \"" + businessdescription + "\", website = \"" + website + "\", phone = \"" + phone + "\", servicedzipcodes = \"" + servicedzipcodes + "\" WHERE seqno = " + seqno;
/*     */ 
