...
/*     */ 
/*     */ public class saveVehicleToMarketplace
/*     */ {
...
/*     */ 
/*     */   public saveVehicleToMarketplace()
/*     */   {
/*     */     try
/*     */     {
...
/*     */   }
/*     */ 
/*     */   public boolean WriteToDB(String date, String vin, String odometer, String servicesRequested, String zipcode)
/*     */   {
...
/*     */       try
/*     */       {
/*  87 */         SQLStr = "INSERT INTO abrstech_obd2db.car_mtnc_request_tbl ( datetime, vin, odometer, servicesrequested, currentzipcode ) VALUES ( \"" + 
/*  88 */           date + "\", \"" + vin + "\",\"" + odometer + "\",\"" + servicesRequested + "\",\"" + zipcode + "\" )";
/*     */ 
 ...
 * Qualified Name:     com.abrstech.sql.saveVehicleToMarketplace
