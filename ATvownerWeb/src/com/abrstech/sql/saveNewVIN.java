...
/*     */   }
/*     */ 
/*     */   public boolean WriteToDB(String country, String vin, String year, String make, String model, String trim, String email, String question, String answer, String zipcode)
/*     */   {
...
/*     */       try
/*     */       {
/*  86 */         SQLStr = "SELECT * from abrstech_obd2db.ref_car_tbl where vin=\"" + vin + "\"";
/*  87 */         this.rs = this.stmt.executeQuery(SQLStr);
/*  88 */         if (this.rs.first()) {
/*  89 */           rvalue = false;
/*  90 */           System.out.println("VIN is already existing: " + vin);
/*     */         } else {
/*  92 */           SQLStr = "INSERT INTO abrstech_obd2db.ref_car_tbl ( datetime, country, vin, year, make, model, trim, email, question, answer, zipcode ) VALUES ( \"" + 
/*  93 */             SystemDT + "\", \"" + country + "\", \"" + vin + "\",\"" + year + "\",\"" + make + "\",\"" + model + "\",\"" + trim + "\",\"" + email + "\",\"" + question + "\",\"" + answer + "\",\"" + zipcode + "\" )";
/*     */ 
