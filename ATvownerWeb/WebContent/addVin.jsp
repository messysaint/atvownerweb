...
<script type="text/javascript" src="/atvownerweb/jscript/validateAddVinForm.js"></script>
...
String loginVehicle = "&nbsp;&nbsp;&nbsp;&nbsp;[&nbsp; <A href=\"/atvownerweb/selectVehicle.jsp\">Login as Vehicle Owner</A> &nbsp;]";
String viewTestVehicle = "&nbsp;&nbsp;[&nbsp; <A href=\"/atvownerweb/viewTestVehicle.jsp\">View Test Vehicle</A> &nbsp;] ";
...
<table border="0">
<form name="addnewvehicle" action="/atvownerweb/saveNewVinToDB.jsp" onsubmit="return validateAddNewVehicleForm()" method="post">
...
<option value="Zimbabwe">Zimbabwe</option>
  ...
  <tr>
    ...
    <td><input type="text" name="reminderquestion" maxlength="50" size="30" value=""/> </td>
  </tr>
  
  <tr>
    <td>Reminder Answer: &nbsp;</td>
    <td><input type="text" name="reminderanswer"   maxlength="50" size="30" value=""/> </td>
  </tr>
