...
<%
	...
	String IVWEB_PARAM = (String) session.getAttribute( "IVWEB_PARAM" ); // retrieve IVWEB_PARAM from HTTP Session
	...
	String htmlFormBegin = "<form id=\"myhiddenform\" name=\"paramNames\" action=\"/atvownerweb/dashBoardParamTrendGraph.jsp\" method=\"post\">";
	...
	ArrayList notifyParams = srchNotifyParameters.getSearchSingleParam( IVWEB_VIN, IVWEB_PARAM );	
	...
	while( iter.hasNext() ) {
		...
		// if( displayValue.equalsIgnoreCase( IVWEB_PARAM ) ) { // only include parameters in notification rules
