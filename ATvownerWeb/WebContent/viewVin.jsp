...
<%
	...
	String htmlFormBegin = "<form id=\"myhiddenform\" name=\"lastLogs\" action=\"/atvownerweb/viewVinStep2.jsp\" method=\"post\">";
	...
	String htmlCheckBoxMid02 = "\">";
        ...
        if ( (logs == null) || (logs.length == 0) ) {
        	...
        	String backToMyAutoMechanic = "/atvownerweb/showError.jsp";
